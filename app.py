...
def makeWebhookResult(req):
        ...
        #retorna para manha
             ...
             speech = "Perfeito! o agendamento foi realizado com sucesso para o período das 8 horas até 12 horas. Você receberá um sms com a confirmação. A porto seguro agradece sua preferência"
             ...
             message = "Seu agendamento está confirmado para hoje no período da manhã"
             ...
             speech = "Perfeito! o agendamento foi realizado com sucesso para o período das 12 horas até 18 horas. Você receberá um sms com a confirmação. A porto seguro agradece sua preferência"
             account_sid = "AC939d6dd17be0fc9b95b70be9e1ee975e"
             auth_token = "221ba8c8cd97e27f28ff0b665f77c973"
             from_number = "+15177265062"  # With trial account, texts can only be sent from your Twilio number.
             to_number = "+5513997984111"
             message = "Seu agendamento está confirmado para hoje no período da tarde"
